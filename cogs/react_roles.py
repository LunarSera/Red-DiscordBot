...
Gave a total of {g} roles."""
    ...
    async def _roles_link(self, ctx, name: str, *linked_messages):
        ...
        Where name is the name of the message that you assigned an Reaction role emoji to.
        'linked_messages' is an arbitrary number channelid-messageid.
        To make a linked_message enable developer options in the discord settings.
        then right click the message you want to assign a reactionrole to.
        copy the number, it will be your messageid.
        Do the same for channelid on the channel you want.
        arrage the numbers you copied in the order shown according to this command.
